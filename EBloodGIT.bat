...
echoj $ba
chgcolor 0f
echoj " Eternal Blood GIT Build Compiler "
chgcolor 0a
chgcolor 0a
echoj $ba $0a
...
:DEVCORE
echo Compiling Eternal Blood Local Development Build...
del .\builds\EternalBlood-DEV.pk3 /q

cd pk3
7za a -y -tzip -mx=0 -mmt -x!.svn ..\builds\EternalBlood-DEV.pk3 .\

pause
goto MENU

:SVNCOREFULL
echo Compiling Eternal Blood GIT Release Rev#: %REVISIONNUMBER% (Full Compression)...
del .\builds\EternalBlood-r%REVISIONNUMBER%.pk3 /q

cd pk3
7za a -y -tzip -mx=9 -mmt -x!.svn ..\builds\EternalBlood-r%REVISIONNUMBER%.pk3 .\
